...
urlpatterns = [
    ...
    path('board/detail/<str:boardno>/', views.board_detail, name='board_detail'),
    path('board/insert/', views.board_insert, name='board_insert'),
    path('board/update/<str:boardno>/', views.board_update, name='board_update'),
    path('board/delete/<str:boardno>/', views.board_delete, name='board_delete'),
